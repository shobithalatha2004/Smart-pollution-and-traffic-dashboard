    ...
    <div className="bg-gray-800/50 p-4 rounded-xl shadow-lg border border-gray-700 h-full">
      ...
      <div style={{ width: '100%', height: 300 }}>
        <ResponsiveContainer>
          <PieChart>
            <Pie
              // FIX: Cast data to 'any' to resolve recharts typing issue where it incorrectly
              ...
              dataKey="value"
              nameKey="name"
              // FIX: The type of `percent` can be a string, causing a type error. Coerce to a number before multiplication.
